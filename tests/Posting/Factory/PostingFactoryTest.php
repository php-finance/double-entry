...
final class PostingFactoryTest extends TestCase
{
    ...
    public function testCreateWithDifferentAccountCharts(
        ...
        $factory = new PostingFactory(
            self::createPostingIdFactory(),
        );

        $date = new DateTimeImmutable();
        $amount = Money::of(100, 'RUB');
        $debitData = new EntryData(self::createAccount(chartId: $debitAccountChartId));
        $creditData = new EntryData(self::createAccount(chartId: $creditAccountChartId));
